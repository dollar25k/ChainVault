...
#[derive(Debug)]
pub struct ChainVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainVault processing");
    
    let mut processor = ChainVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainVaultProcessor::new(false);
